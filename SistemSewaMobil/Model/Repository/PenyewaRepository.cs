...
namespace SistemSewaMobil.Model.Repository
{
    ...
    public int Update(Penyewa penyewa)
        ...
        public string GetIdByNama(string nama)
        {
            ...
            string sql = "SELECT idPenyewa, alamatPenyewa FROM penyewa WHERE namaPenyewa = @namaPenyewa";
        ...
        VALUES (@namaPenyewa, @alamatPenyewa, @noKtpPenyewa, @noHpPenyewa)";
            ...
            using (SqlCommand cmd = new SqlCommand(sql, _conn))
            {
                cmd.Parameters.AddWithValue("@namaPenyewa", p.namaPenyewa);
                cmd.Parameters.AddWithValue("@alamatPenyewa", p.alamatPenyewa);
                cmd.Parameters.AddWithValue("@noKtpPenyewa", p.noKtpPenyewa);
                cmd.Parameters.AddWithValue("@noHpPenyewa", p.noHpPenyewa);
