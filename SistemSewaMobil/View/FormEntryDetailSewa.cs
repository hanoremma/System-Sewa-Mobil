...
namespace SistemSewaMobil
{
    ...
    public partial class FormEntryDetailSewa : Form
    {
        public FormEntryDetailSewa()
        {
            ...
            textBoxIDPenyewa.Enabled = false;
        ...
        private void txtNamaPenyewaDetailSewa_TextChanged(object sender, EventArgs e)
        {
        ...
        private void ktpNoKtpDetailSewa_TextChanged(object sender, EventArgs e)
        {
